...
class Class_Period(db.Model):
    ...
    # Time columns now store only the time (e.g., '10:00')
    period_start_time = db.Column(db.String(5), nullable=False)
    period_end_time = db.Column(db.String(5), nullable=False)
